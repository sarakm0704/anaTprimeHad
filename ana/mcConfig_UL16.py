...
config = {
        ...
        # BTV efficiency map
        'fname_btagEff': 'data/BTV/2016postVFP_UL/2016_btagEff_VLQ_FH.json',
        'fname_btagRatio': 'data/BTV/2016postVFP_UL/2016_btagTF_VLQ_FH.json',
        # json file name for JERC
        'jercfname': 'data/JERC/jetUL16_jerc.json',
        # conbined correction type for jets
        'jerctag': 'Summer20UL16_JRV3_MC_PtResolution_AK4PFchs', 
        # jet uncertainty 
        'jercunctag': 'Summer20UL16_JRV3_MC_ScaleFactor_AK4PFchs', 
        'jercsys_total': 'Summer19UL16_V7_MC_Regrouped_Total_AK4PFchs'
        }
