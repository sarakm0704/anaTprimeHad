...
void NanoAODAnalyzerrdframe::setParams(int year, string runtype, int datatype, string sampletype, string topPtReweight, string topPtReweightsys, string jecsys, string jersys, string btagsys, string btagsysuncorr)
{
    /*if(debug){
        std::cout<< "================================//=================================" << std::endl;
    ...
    if(_sampletype.find("Tprime")){
        _isTprime = true;
        cout << "Running Tprime signal sample" << endl;
    }else if(_sampletype.find("TTToHadronic")){
        _isTT = true;
        cout << "Running background sample TTToHadronic" << endl;
    }else if(_sampletype.find("QCD")){
        _isQCD = true;
