...
for r in regions:
    ...
    outloc = f'/Users/jieun/WORK/vlq/plot/quickDraw/trigEff/background/{r}'
...
#    input_var = ['goodht','jet1_pt','jet2_pt','jet3_pt','jet4_pt','jet5_pt','jet1_btag','jet2_btag','jet3_btag','mass_leadjets','mass_w','mass_h','mass_top','mass_wh','mass_secondtop','mass_tprime']
    for var in input_var:
        ...
        # Main plot
        # standard
#        hep.histplot(h_eff_tp600, binning, ax=ax, histtype='errorbar', color='#0051FF', capsize=2, xerr=True, yerr=True, label="Tprime 600")
#        hep.histplot(h_eff_tot, binning, ax=ax, histtype='errorbar', color='#185358', capsize=2, xerr=True, yerr=True, label="All background MC")
        ...
        fig.savefig(f"{outloc}/mc_{var}.png")
        fig.savefig(f"{outloc}/mc_{var}.pdf")
        plt.close()
