...
regions = ['2M1L','3M','3T']
myc = ['#016fb9','#67A239','#847E2B','#345325','#ef8a17','#D81200','#8029BD','#FF007B','#5790FC','#000000']
...
# 2017
    d = d.loc[(d['HLT_HT300PT30_QuadJet_75_60_45_40_TripleCSV_p07']==1)]
    return d
...
# 2017
    d = d.loc[(d['HLT_PFHT300PT30_QuadPFJet_75_60_45_40_TriplePFBTagCSV_3p0']==1)]
    return d
...
# 2017
    d = d.loc[(d['HLT_PFHT380_SixJet32_DoubleBTagCSV_p075']==1)]    
    return d
...
# 2017
    d = d.loc[(d['HLT_PFHT430_SixJet40_BTagCSV_p080']==1)]
    return d
...
# 2017
    d = d.loc[(d['HLT_PFHT380_SixPFJet32_DoublePFBTagCSV_2p2']==1)]    
    return d
...
# 2017
    d = d.loc[(d['HLT_PFHT430_SixPFJet40_PFBTagCSV_1p5']==1)]
    return d
...
# 2017
    d = d.loc[ (d['HLT_HT300PT30_QuadJet_75_60_45_40_TripleCSV_p07']==1) | (d['HLT_PFHT300PT30_QuadPFJet_75_60_45_40_TriplePFBTagCSV_3p0']==1) | (d['HLT_PFHT380_SixJet32_DoubleBTagCSV_p075']==1) | (d['HLT_PFHT430_SixJet40_BTagCSV_p080']==1) | (d['HLT_PFHT380_SixPFJet32_DoublePFBTagCSV_2p2']==1) | (d['HLT_PFHT380_SixPFJet32_DoublePFBTagCSV_2p2']==1) | (d['HLT_PFHT430_SixPFJet40_PFBTagCSV_1p5']==1) | (d['HLT_PFHT380_SixPFJet32_DoublePFBTagDeepCSV_2p2']==1) | (d['HLT_PFHT1050']==1) | (d['HLT_PFJet500']==1) ]
...
for r in regions:
    ...
    loc = f'/Users/jieun/WORK/vlq/dnn/training/array/woHLT/Jet25/2017/{r}/'
    outloc = f'./output/2017/{r}'
...
#    input_var = ['goodht','jet1_pt','jet2_pt','jet3_pt','jet4_pt','jet5_pt','jet1_btag','jet2_btag','jet3_btag','mass_leadjets','mass_w','mass_h','mass_top','mass_wh','mass_secondtop','mass_tprime']
    for var in input_var:
        ...
        hep.style.use("CMS")
        fig, ax = plt.subplots()
        hep.cms.label("Preliminary", com = 13, lumi = 41.5, data = True, loc=0, ax=ax);
        ...
        hlt_errs = [hlt1_err,hlt2_err,hlt3_err,hlt4_err,hlt5_err,hlt6_err,hlt7_err,hlt8_err,hlt9_err,hltall_err]

        # Main plot
        # standard
        hep.histplot([h_eff_hlt1, h_eff_hlt2, h_eff_hlt3, h_eff_hlt4, h_eff_hlt5, h_eff_hlt6, h_eff_hlt7, h_eff_hlt8, h_eff_hlt9, h_eff_hltall], binning, ax=ax, histtype='errorbar', color=myc, capsize=2, xerr=True, yerr=hlt_errs, label=["HLT_HT300PT30_QuadJet_75_60_45_40_TripleCSV_p07","HLT_PFHT300PT30_QuadPFJet_75_60_45_40_TriplePFBTagCSV_3p0","HLT_PFHT380_SixJet32_DoubleBTagCSV_p075","HLT_PFHT430_SixJet40_BTagCSV_p080","HLT_PFHT380_SixPFJet32_DoublePFBTagCSV_2p2","HLT_PFHT430_SixPFJet40_PFBTagCSV_1p5","HLT_PFHT380_SixPFJet32_DoublePFBTagDeepCSV_2p2","HLT_PFHT1050","HLT_PFJet500","OR of all Triggers"])
